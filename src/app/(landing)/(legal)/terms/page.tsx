  ...
  return (
    <div className="mx-auto min-h-screen max-w-3xl px-4">
      ...
      <Para className="text-center text-xs">
        Learn more about how PDX collects and uses data and your rights
        as a PDX user
      </Para>
      ...
      <main className="py-16">
        ...
        <Para className="mt-6">
          Welcome to PDX ("we," "our," or "us"). By accessing or using
          ...
          using PDX. If you do not agree with these Terms, you must not
          use our Services.
        </Para>
        ...
        <div className="mt-8 space-y-8">
          ...
          <section>
            ...
            <Para>
              While PDX strives to provide accurate and high-quality
          ...
          <section>
            ...
            <Para>
              You must be at least 13 years old to use PDX. By accessing
          ...
          <section>
            ...
            <div className="space-y-3">
              <p>
                ...
                PDX reserves the right to pursue legal action if deemed
                necessary.
              </p>
              <p>
          ...
          <section>
            ...
            <div className="space-y-3">
              <p>
                All materials generated by PDX, including study guides
          ...
          <section>
            ...
            <div className="space-y-3">
              <p>
                PDX provides study materials and resources as-is. While
              ...
              <p>
                To the maximum extent permitted by law, PDX's liability
                for any claims, damages, or losses arising from your use of our
                Services is limited to the amount you have paid to PDX,
          ...
          <Para className="mt-8 font-medium">
            By using PDX, you acknowledge that you have read,
